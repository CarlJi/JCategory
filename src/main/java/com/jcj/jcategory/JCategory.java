...
public class JCategory extends Suite
{
	...
	public JCategory(Class<?> suiteClass, RunnerBuilder builder) throws InitializationError
	{
		...
		try
		{
			filter(new AnnotationsFilterBuilder(getIncludedSprint(suiteClass), getIncludedUserStory(suiteClass), getIncludedDefect(suiteClass)
					,getExcludedSprint(suiteClass), getExcludedUserStory(suiteClass), getExcludedDefect(suiteClass)));
		}
	...
	private String getExcludedSprint(Class<?> classes)
	{
		ExcludeSprint annotation = classes.getAnnotation(ExcludeSprint.class);
		return annotation == null ? null : annotation.value();
	}
	
	private String getExcludedUserStory(Class<?> classes)
	{
		ExcludeUserStory annotation = classes.getAnnotation(ExcludeUserStory.class);
		return annotation == null ? null : annotation.value();
	}
	
	private String getExcludedDefect(Class<?> classes)
	{
		ExcludeDefect annotation = classes.getAnnotation(ExcludeDefect.class);
		return annotation == null ? null : annotation.value();
	}
